...
C===========================================================================
      ...
      Function Ctq5Pdf_orig (Iparton, X, Q)
	...
	Print *, 'X out of range in Ctq5Pdf_orig: ', X
	Stop
      Endif
      If (Q .lt. Alambda) Then
	Print *, 'Q out of range in Ctq5Pdf_orig: ', Q
	Stop
      Endif
...
C        put a warning for calling extra flavor.
	     Warn = .false.
	     Print *, 'Warning: Iparton out of range in Ctq5Pdf_orig: '
     >              , Iparton
         Endif
         Ctq5Pdf_orig = 0D0
         Return
      ...
      Ctq5Pdf_orig = PartonX (Iparton, X, Q)
      if(Ctq5Pdf_orig.lt.0.D0)  Ctq5Pdf_orig = 0.D0
...
C                        ****************************
     ...
     > / 'cteq/cteq5m.tbl', 'cteq/cteq5d.tbl', 
     >   'cteq/cteq5l.tbl', 'cteq/cteq5hj.tbl'
     > , 'cteq/cteq5hq.tbl', 'cteq/cteq5f3.tbl', 'cteq/cteq5f4.tbl'
     > , 'cteq/cteq5m1.tbl', 'cteq/ctq5hq1.tbl'  /
