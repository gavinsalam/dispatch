...
!
! $Id: warnings_and_errors.f90,v 1.1 2001/10/19 22:10:57 gsalam Exp $
!======================================================================
...
contains
  ...
  subroutine wae_warn(max_warn, warn_id, text, text2, text3)
    ...
    if (nwarn < max_warn) then
       ...
       if (present(text2)) write(0,'(a)') text3
  ...
  !======================================================================
  subroutine wae_error(text1, text2, text3)
